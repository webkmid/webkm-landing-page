...
const steps = [
  {
    num: "01",
    title: "Konsultasi",
    desc: "Diskusi kebutuhan dan tujuan bisnis kamu secara gratis.",
  },
  {
    num: "02",
    title: "Proposal",
    desc: "Kami kirimkan proposal harga dan timeline yang jelas.",
  },
  {
    num: "03",
    title: "Pengerjaan",
    desc: "Tim kami mulai bekerja, kamu bisa pantau progresnya.",
  },
  {
    num: "04",
    title: "Revisi",
    desc: "Feedback kamu kami tampung dan segera diimplementasikan.",
  },
  {
    num: "05",
    title: "Live!",
    desc: "Website kamu tayang dan siap terima pelanggan online.",
  },
];
    ...
    <>
      ...
      >
        ...
        >
          ...
          <a
            href="https://wa.me/6282295285472"
            target="_blank"
            className="cta"
            style={{
              background: "#111",
        ...
        <section
          className="hero"
          style={{ padding: "6rem 5% 3rem", textAlign: "center" }}
        >
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            ...
            >
              Kami bantu UMKM Indonesia tampil profesional di dunia digital —
              dari website, branding, SEO, hingga iklan online.
            </p>
            <div
              style={{
                display: "flex",
        ...
        >
          {[
            ...
            >
              <div style={{ fontSize: 32, fontWeight: 500, letterSpacing: -1 }}>
                {num}
              </div>
        ...
        <section style={{ padding: "4rem 5%" }}>
          <div style={{ marginBottom: "2.5rem" }}>
            ...
            >
              Satu tempat untuk semua kebutuhan digital UMKM kamu.
            </p>
          </div>
          <div
          ...
          >
            {services.map((s) => (
              <div
                key={s.title}
                style={{ background: "#fff", padding: "1.75rem" }}
              >
                <div
                  style={{
                    width: 40,
                ...
                <h3 style={{ fontSize: 15, fontWeight: 500, marginBottom: 6 }}>
                  {s.title}
                </h3>
        ...
        <section
          id="pricing"
          style={{ padding: "4rem 5%", background: "#f8f8f7" }}
        >
          <div style={{ marginBottom: "2.5rem" }}>
            <div
              style={{
            ...
            >
              Pilih paket yang sesuai kebutuhan bisnis kamu saat ini.
            </p>
          </div>
          <div
        ...
        <section style={{ padding: "4rem 5%" }}>
          <div style={{ marginBottom: "2.5rem" }}>
            ...
            >
              Dari konsultasi hingga website live, kami dampingi setiap
              langkahnya.
            </p>
          </div>
          <div
        ...
        <section style={{ padding: "4rem 5%" }}>
          ...
          >
            <div>
              ...
              >
                Setiap proyek dibuat dengan penuh perhatian terhadap detail dan
                kebutuhan bisnis client.
              </p>
            </div>
            ...
            >
              ...
              <button
                onClick={() =>
                  setActiveSlide((p) => Math.min(portfolios.length - 3, p + 1))
                }
                ...
                style={{
                  ...
                  border: "0.5px solid #e5e5e5",
                  background:
                    activeSlide >= portfolios.length - 3 ? "#f8f8f7" : "#fff",
                  cursor:
                    activeSlide >= portfolios.length - 3
                      ? "not-allowed"
                      : "pointer",
                  display: "flex",
                  alignItems: "center",
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        inset: 0,
                        background:
                          "linear-gradient(to bottom, transparent 60%, rgba(0,0,0,0.08))",
                      }}
                    />
                  </div>
