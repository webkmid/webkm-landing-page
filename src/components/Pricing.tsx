...
const pricingPlans = [
  ...
  { name: 'UMKM Premium', price: 'Rp 500.000', features: ['• Template Premium', '• Hosting & Subdomain', '• Integrasi Social Media', '• Tambahan Hingga 2 Section','• 1x Update Konten Per Bulan','• 2x Revisi Design, Custom Warna','• Basic SEO',], cta: 'Pilih Paket', featured: false },
  ...
  return (
    <section ref={sectionRef} id="pricing" className="py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="horizontal-track flex gap-6 overflow-x-auto snap-mandatory pb-4 mt-6 cursor-grab active:cursor-grabbing">
          {pricingPlans.map(plan => (
            <div key={plan.name} className={`snap-start shrink-0 flex flex-col overflow-y-visible relative w-[320px] bg-white rounded-2xl p-6 border transition-transform duration-300 ${plan.featured ? 'border-2 border-indigo-500 shadow-xl scale-105' : 'border-slate-100 shadow-md'}`}>
